...
# ПРОВЕРКА: Попытка импорта
print("=== Попытка импорта analyze ===")
try:
    import analyze
    print(f"✅ analyze успешно импортирован")
    print(f"Функции в analyze: {[x for x in dir(analyze) if not x.startswith('_')]}")
except Exception as e:
    print(f"❌ Ошибка импорта analyze: {e}")
print("=================================")
